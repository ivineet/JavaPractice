...
public class StudentTest {
	...
	public void testCase1() {
		...
		assertTrue(st.getUnits() == 18);
		assertTrue(st.getStress() == 180);
	}
	
	@Test
	public void testCase2() {
		Student st = new Student();
		assertTrue(st.getUnits() == 15);
		st.dropUnits(2);
		assertTrue(st.getUnits() == 13);
		st.dropUnits(10);
		assertTrue(st.getUnits() == 13);
...
// we'll use the testStudent for the next three test cases
	...
	@Test
	public void testOne() {
		assertTrue(testStudent.getStress() == 200);
	...
	@Test
	public void testTwo() {
		assertTrue(testStudent.getUnits() == 20);
